                ...
                <div className="card p-4">
                  ...
                  <form onSubmit={addVocab} className="space-y-3">
                    ...
                    <button type="submit" disabled={addingVocab}
                      className="flex items-center gap-1.5 bg-accent text-white px-4 py-2 rounded-xl text-sm font-bold hover:bg-accent/90 disabled:opacity-50 transition-colors">
