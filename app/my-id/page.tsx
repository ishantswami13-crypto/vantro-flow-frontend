        ...
        <div className="card-premium p-5">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={shareLink}
              className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl bg-gray-900 text-white text-xs font-semibold hover:bg-gray-800 transition-all shrink-0 shadow-button-accent">
              <FiShare2 size={13} />
              Share
            </button>
          </div>
