          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-10">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl text-base font-semibold text-secondary bg-surface-2 border border-border hover:border-accent/40 hover:text-primary transition-all">
                👀 Try Demo — No Signup
              </button>
            </div>
