...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-bg text-primary font-sans overflow-x-hidden">
      ...
      <a href={`https://wa.me/${WA_NUMBER}?text=Hi%2C%20I%20want%20to%20know%20more%20about%20Vantro`}
        target="_blank" rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:bg-[#20BA5A] hover:scale-110 transition-all"
