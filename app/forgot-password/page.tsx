          ...
          {step === "done" && (
            <div className="text-center py-4 space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-white text-black font-bold text-sm shadow-button-accent hover:bg-white/90 transition-all"
              >
            ...
            <>
              ...
              <form onSubmit={handleSendOTP} className="space-y-4">
                ...
                <button type="submit" disabled={loading || !email}
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-white text-black font-bold text-sm shadow-button-accent hover:bg-white/90 transition-all disabled:opacity-40">
                  {loading
