      ...
      <div className="space-y-6 page-enter">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <button onClick={openAdd}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white text-black text-sm font-semibold hover:bg-white/90 transition-all shadow-button-accent self-start sm:self-auto">
        ...
        {!loading && filtered.length === 0 && (
          <div className="card-premium p-12 flex flex-col items-center text-center">
            ...
            {prospects.length === 0 && (
              <button onClick={openAdd}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white text-black text-xs font-semibold hover:bg-white/90 transition-all">
              ...
              <form onSubmit={handleSave} className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button type="submit" disabled={saving}
                    className="flex-1 py-2.5 rounded-xl text-sm font-semibold bg-white text-black hover:bg-white/90 disabled:opacity-60 transition-all shadow-button-accent flex items-center justify-center gap-2">
