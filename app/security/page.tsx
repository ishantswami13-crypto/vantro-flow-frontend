...
export const metadata: Metadata = {
  title: "Security — Starlane by Vantro",
  description: "How Vantro protects your business data inside Starlane.",
};
      ...
      <div className="legal-body">
        <div className="wrap">
          <div className="legal-content">
            <p>Your business data is sensitive. Here&apos;s exactly how Vantro protects it inside Starlane — no vague claims.</p>
            ...
            <p>Vantro / Starlane does not store, process or transmit cardholder data. All payment processing is handled by <strong>Razorpay</strong>, which is PCI-DSS Level 1 compliant. We store only a non-reversible payment token for subscription management.</p>
