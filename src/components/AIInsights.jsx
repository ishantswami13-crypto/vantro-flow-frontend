  ...
  return (
    <div className="ai-insights">
      <div className="ai-insights-header">
        <div>
          <h2>🤖 AI Insights</h2>
          <p>Smart analysis of your business data</p>
        </div>
      ...
      {loading && !data && (
        <div className="ai-loading">
          ...
          <p>AI is analysing your business data...</p>
        </div>
      )}
        ...
        <>
          ...
          <div className="insights-section-grid">
            ...
            <div className="insights-panel">
              ...
              {data.stats.productSales.length > 0 && data.stats.productSales.length > 1 && (
                <div className="prod-slow">
                  🐢 Slowest: <strong>{data.stats.productSales[data.stats.productSales.length - 1].name}</strong>
                </div>
              )}
            </div>
            ...
            <div className="insights-panel">
              ...
              <div className="call-stat-row">
                ...
                <strong style={{color: data.stats.totalCalls ? (data.stats.pickedUp/data.stats.totalCalls > 0.5 ? '#16a34a' : '#dc2626') : '#94a3b8'}}>
